...
```txt
From: 20 February 2025 - To: 24 July 2026

Total Time: 599 hrs 19 mins

TypeScript    295 hrs 3 mins        >>>>>>>>>>>>>>>>>>>>>>>>>   48.85 %
Python        161 hrs 41 mins       >>>>>>>>>>>>>>>>>>>>>>>>>   26.77 %
Markdown      44 hrs 28 mins        >>>>>>>>>>>>>>>>>>>>>>>>>   07.36 %
C             33 hrs 5 mins         >>>>>>>>>>>>>>>>>>>>>>>>>   05.48 %
JSON          14 hrs 33 mins        >>>>>>>>>>>>>>>>>>>>>>>>>   02.41 %
```
