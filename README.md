...
```txt
From: 20 February 2025 - To: 22 July 2026

Total Time: 589 hrs 22 mins

TypeScript    291 hrs 23 mins       >>>>>>>>>>>>>>>>>>>>>>>>>   49.07 %
Python        161 hrs 41 mins       >>>>>>>>>>>>>>>>>>>>>>>>>   27.23 %
Markdown      40 hrs 3 mins         >>>>>>>>>>>>>>>>>>>>>>>>>   06.75 %
C             33 hrs 5 mins         >>>>>>>>>>>>>>>>>>>>>>>>>   05.57 %
JSON          14 hrs 25 mins        >>>>>>>>>>>>>>>>>>>>>>>>>   02.43 %
```
