...
```txt
From: 20 February 2025 - To: 25 April 2025

Total Time: 87 hrs 27 mins

C             31 hrs 57 mins  >>>>>>>>>>>>>>>>>>>>>>>>>   36.39 %
TypeScript    20 hrs 59 mins  >>>>>>>>>>>>>>>>>>>>>>>>>   23.89 %
Python        17 hrs 45 mins  >>>>>>>>>>>>>>>>>>>>>>>>>   20.22 %
JavaScript    6 hrs 55 mins   >>>>>>>>>>>>>>>>>>>>>>>>>   07.89 %
JSON          2 hrs 28 mins   >>>>>>>>>>>>>>>>>>>>>>>>>   02.81 %
```
