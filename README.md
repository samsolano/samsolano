...
```txt
From: 20 February 2025 - To: 03 June 2025

Total Time: 132 hrs 21 mins

TypeScript    43 hrs 59 mins  >>>>>>>>>>>>>>>>>>>>>>>>>   33.10 %
C             32 hrs 45 mins  >>>>>>>>>>>>>>>>>>>>>>>>>   24.64 %
Python        32 hrs 10 mins  >>>>>>>>>>>>>>>>>>>>>>>>>   24.21 %
JavaScript    9 hrs 15 mins   >>>>>>>>>>>>>>>>>>>>>>>>>   06.97 %
JSON          3 hrs 39 mins   >>>>>>>>>>>>>>>>>>>>>>>>>   02.75 %
```
