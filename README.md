...
```txt
From: 20 February 2025 - To: 03 July 2026

Total Time: 571 hrs 5 mins

TypeScript    279 hrs 59 mins       >>>>>>>>>>>>>>>>>>>>>>>>>   48.71 %
Python        161 hrs 41 mins       >>>>>>>>>>>>>>>>>>>>>>>>>   28.13 %
Markdown      35 hrs 50 mins        >>>>>>>>>>>>>>>>>>>>>>>>>   06.23 %
C             33 hrs 5 mins         >>>>>>>>>>>>>>>>>>>>>>>>>   05.76 %
JSON          13 hrs 47 mins        >>>>>>>>>>>>>>>>>>>>>>>>>   02.40 %
```
