...
```txt
From: 20 February 2025 - To: 03 March 2026

Total Time: 458 hrs 34 mins

TypeScript    207 hrs 10 mins       >>>>>>>>>>>>>>>>>>>>>>>>>   45.03 %
Python        145 hrs 16 mins       >>>>>>>>>>>>>>>>>>>>>>>>>   31.57 %
C             33 hrs 5 mins         >>>>>>>>>>>>>>>>>>>>>>>>>   07.19 %
Markdown      21 hrs 12 mins        >>>>>>>>>>>>>>>>>>>>>>>>>   04.61 %
JSON          10 hrs 27 mins        >>>>>>>>>>>>>>>>>>>>>>>>>   02.27 %
```
