...
```txt
From: 20 February 2025 - To: 10 August 2026

Total Time: 623 hrs 41 mins

TypeScript    306 hrs 34 mins       >>>>>>>>>>>>>>>>>>>>>>>>>   48.68 %
Python        161 hrs 46 mins       >>>>>>>>>>>>>>>>>>>>>>>>>   25.69 %
Markdown      52 hrs 4 mins         >>>>>>>>>>>>>>>>>>>>>>>>>   08.27 %
C             33 hrs 5 mins         >>>>>>>>>>>>>>>>>>>>>>>>>   05.26 %
JSON          14 hrs 52 mins        >>>>>>>>>>>>>>>>>>>>>>>>>   02.36 %
```
