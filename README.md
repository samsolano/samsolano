...
```txt
From: 20 February 2025 - To: 27 June 2026

Total Time: 567 hrs 28 mins

TypeScript    277 hrs 54 mins       >>>>>>>>>>>>>>>>>>>>>>>>>   48.66 %
Python        161 hrs 41 mins       >>>>>>>>>>>>>>>>>>>>>>>>>   28.31 %
Markdown      34 hrs 36 mins        >>>>>>>>>>>>>>>>>>>>>>>>>   06.06 %
C             33 hrs 5 mins         >>>>>>>>>>>>>>>>>>>>>>>>>   05.79 %
JSON          13 hrs 45 mins        >>>>>>>>>>>>>>>>>>>>>>>>>   02.41 %
```
