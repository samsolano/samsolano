...
```txt
From: 20 February 2025 - To: 15 August 2025

Total Time: 224 hrs 29 mins

TypeScript    91 hrs 24 mins  >>>>>>>>>>>>>>>>>>>>>>>>>   40.55 %
Python        60 hrs 32 mins  >>>>>>>>>>>>>>>>>>>>>>>>>   26.85 %
C             32 hrs 47 mins  >>>>>>>>>>>>>>>>>>>>>>>>>   14.55 %
JavaScript    9 hrs 34 mins   >>>>>>>>>>>>>>>>>>>>>>>>>   04.25 %
JSON          6 hrs 30 mins   >>>>>>>>>>>>>>>>>>>>>>>>>   02.89 %
```
