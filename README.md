...
```txt
From: 20 February 2025 - To: 06 May 2025

Total Time: 95 hrs 30 mins

C             32 hrs 45 mins  >>>>>>>>>>>>>>>>>>>>>>>>>   34.14 %
TypeScript    24 hrs 46 mins  >>>>>>>>>>>>>>>>>>>>>>>>>   25.83 %
Python        17 hrs 51 mins  >>>>>>>>>>>>>>>>>>>>>>>>>   18.62 %
JavaScript    8 hrs 43 mins   >>>>>>>>>>>>>>>>>>>>>>>>>   09.10 %
JSON          2 hrs 31 mins   >>>>>>>>>>>>>>>>>>>>>>>>>   02.63 %
```
