...
```txt
From: 20 February 2025 - To: 01 May 2026

Total Time: 510 hrs 38 mins

TypeScript    237 hrs 19 mins       >>>>>>>>>>>>>>>>>>>>>>>>>   46.17 %
Python        156 hrs 27 mins       >>>>>>>>>>>>>>>>>>>>>>>>>   30.44 %
C             33 hrs 5 mins         >>>>>>>>>>>>>>>>>>>>>>>>>   06.44 %
Markdown      26 hrs 45 mins        >>>>>>>>>>>>>>>>>>>>>>>>>   05.21 %
JSON          12 hrs 35 mins        >>>>>>>>>>>>>>>>>>>>>>>>>   02.45 %
```
