...
```txt
From: 20 February 2025 - To: 31 March 2026

Total Time: 474 hrs 14 mins

TypeScript    215 hrs 18 mins       >>>>>>>>>>>>>>>>>>>>>>>>>   45.25 %
Python        150 hrs 29 mins       >>>>>>>>>>>>>>>>>>>>>>>>>   31.63 %
C             33 hrs 5 mins         >>>>>>>>>>>>>>>>>>>>>>>>>   06.96 %
Markdown      22 hrs 58 mins        >>>>>>>>>>>>>>>>>>>>>>>>>   04.83 %
JSON          10 hrs 52 mins        >>>>>>>>>>>>>>>>>>>>>>>>>   02.28 %
```
