...
```txt
From: 20 February 2025 - To: 13 April 2025

Total Time: 67 hrs 39 mins

C             29 hrs 20 mins  >>>>>>>>>>>>>>>>>>>>>>>>>   43.23 %
Python        13 hrs 44 mins  >>>>>>>>>>>>>>>>>>>>>>>>>   20.26 %
TypeScript    10 hrs 7 mins   >>>>>>>>>>>>>>>>>>>>>>>>>   14.92 %
JavaScript    5 hrs 31 mins   >>>>>>>>>>>>>>>>>>>>>>>>>   08.15 %
JSON          2 hrs 13 mins   >>>>>>>>>>>>>>>>>>>>>>>>>   03.29 %
```
