...
```txt
From: 20 February 2025 - To: 18 March 2026

Total Time: 463 hrs 2 mins

TypeScript    209 hrs 11 mins       >>>>>>>>>>>>>>>>>>>>>>>>>   45.03 %
Python        147 hrs               >>>>>>>>>>>>>>>>>>>>>>>>>   31.64 %
C             33 hrs 5 mins         >>>>>>>>>>>>>>>>>>>>>>>>>   07.12 %
Markdown      21 hrs 50 mins        >>>>>>>>>>>>>>>>>>>>>>>>>   04.70 %
JSON          10 hrs 31 mins        >>>>>>>>>>>>>>>>>>>>>>>>>   02.27 %
```
