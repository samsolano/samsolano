...
```txt
From: 20 February 2025 - To: 07 May 2025

Total Time: 99 hrs 15 mins

C             32 hrs 45 mins  >>>>>>>>>>>>>>>>>>>>>>>>>   32.86 %
TypeScript    28 hrs 14 mins  >>>>>>>>>>>>>>>>>>>>>>>>>   28.34 %
Python        17 hrs 51 mins  >>>>>>>>>>>>>>>>>>>>>>>>>   17.92 %
JavaScript    8 hrs 44 mins   >>>>>>>>>>>>>>>>>>>>>>>>>   08.76 %
JSON          2 hrs 31 mins   >>>>>>>>>>>>>>>>>>>>>>>>>   02.54 %
```
