...
```txt
From: 20 February 2025 - To: 17 September 2026

Total Time: 655 hrs 29 mins

TypeScript    327 hrs 20 mins       >>>>>>>>>>>>>>>>>>>>>>>>>   49.39 %
Python        161 hrs 46 mins       >>>>>>>>>>>>>>>>>>>>>>>>>   24.41 %
Markdown      61 hrs 7 mins         >>>>>>>>>>>>>>>>>>>>>>>>>   09.22 %
C             33 hrs 5 mins         >>>>>>>>>>>>>>>>>>>>>>>>>   04.99 %
JSON          15 hrs                >>>>>>>>>>>>>>>>>>>>>>>>>   02.26 %
```
