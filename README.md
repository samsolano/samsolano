...
```txt
From: 20 February 2025 - To: 15 May 2026

Total Time: 518 hrs 39 mins

TypeScript    241 hrs 48 mins       >>>>>>>>>>>>>>>>>>>>>>>>>   46.25 %
Python        159 hrs 4 mins        >>>>>>>>>>>>>>>>>>>>>>>>>   30.43 %
C             33 hrs 5 mins         >>>>>>>>>>>>>>>>>>>>>>>>>   06.33 %
Markdown      27 hrs 8 mins         >>>>>>>>>>>>>>>>>>>>>>>>>   05.19 %
JSON          12 hrs 39 mins        >>>>>>>>>>>>>>>>>>>>>>>>>   02.42 %
```
