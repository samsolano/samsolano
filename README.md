...
```txt
From: 20 February 2025 - To: 09 June 2026

Total Time: 554 hrs 26 mins

TypeScript    269 hrs 10 mins       >>>>>>>>>>>>>>>>>>>>>>>>>   48.27 %
Python        161 hrs 32 mins       >>>>>>>>>>>>>>>>>>>>>>>>>   28.97 %
C             33 hrs 5 mins         >>>>>>>>>>>>>>>>>>>>>>>>>   05.94 %
Markdown      31 hrs 4 mins         >>>>>>>>>>>>>>>>>>>>>>>>>   05.57 %
JSON          13 hrs 29 mins        >>>>>>>>>>>>>>>>>>>>>>>>>   02.42 %
```
