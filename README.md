...
```txt
From: 20 February 2025 - To: 02 May 2025

Total Time: 91 hrs 48 mins

C             31 hrs 57 mins  >>>>>>>>>>>>>>>>>>>>>>>>>   34.68 %
TypeScript    22 hrs 48 mins  >>>>>>>>>>>>>>>>>>>>>>>>>   24.75 %
Python        17 hrs 45 mins  >>>>>>>>>>>>>>>>>>>>>>>>>   19.27 %
JavaScript    8 hrs 41 mins   >>>>>>>>>>>>>>>>>>>>>>>>>   09.42 %
JSON          2 hrs 28 mins   >>>>>>>>>>>>>>>>>>>>>>>>>   02.69 %
```
