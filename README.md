...
```txt
From: 20 February 2025 - To: 29 July 2026

Total Time: 601 hrs 58 mins

TypeScript    296 hrs 41 mins       >>>>>>>>>>>>>>>>>>>>>>>>>   48.91 %
Python        161 hrs 41 mins       >>>>>>>>>>>>>>>>>>>>>>>>>   26.65 %
Markdown      45 hrs 11 mins        >>>>>>>>>>>>>>>>>>>>>>>>>   07.45 %
C             33 hrs 5 mins         >>>>>>>>>>>>>>>>>>>>>>>>>   05.46 %
JSON          14 hrs 33 mins        >>>>>>>>>>>>>>>>>>>>>>>>>   02.40 %
```
