...
```txt
From: 20 February 2025 - To: 01 June 2026

Total Time: 540 hrs 7 mins

TypeScript    257 hrs 48 mins       >>>>>>>>>>>>>>>>>>>>>>>>>   47.46 %
Python        161 hrs 32 mins       >>>>>>>>>>>>>>>>>>>>>>>>>   29.74 %
C             33 hrs 5 mins         >>>>>>>>>>>>>>>>>>>>>>>>>   06.09 %
Markdown      28 hrs 29 mins        >>>>>>>>>>>>>>>>>>>>>>>>>   05.25 %
JSON          13 hrs 18 mins        >>>>>>>>>>>>>>>>>>>>>>>>>   02.45 %
```
