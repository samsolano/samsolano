...
```txt
From: 20 February 2025 - To: 03 May 2025

Total Time: 93 hrs 5 mins

C             31 hrs 57 mins  >>>>>>>>>>>>>>>>>>>>>>>>>   34.20 %
TypeScript    23 hrs 49 mins  >>>>>>>>>>>>>>>>>>>>>>>>>   25.50 %
Python        17 hrs 45 mins  >>>>>>>>>>>>>>>>>>>>>>>>>   19.00 %
JavaScript    8 hrs 43 mins   >>>>>>>>>>>>>>>>>>>>>>>>>   09.33 %
JSON          2 hrs 31 mins   >>>>>>>>>>>>>>>>>>>>>>>>>   02.70 %
```
