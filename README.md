...
```txt
From: 20 February 2025 - To: 25 June 2025

Total Time: 161 hrs 17 mins

TypeScript    57 hrs 8 mins   >>>>>>>>>>>>>>>>>>>>>>>>>   35.22 %
Python        42 hrs 19 mins  >>>>>>>>>>>>>>>>>>>>>>>>>   26.09 %
C             32 hrs 47 mins  >>>>>>>>>>>>>>>>>>>>>>>>>   20.22 %
JavaScript    9 hrs 34 mins   >>>>>>>>>>>>>>>>>>>>>>>>>   05.91 %
JSON          4 hrs 29 mins   >>>>>>>>>>>>>>>>>>>>>>>>>   02.76 %
```
