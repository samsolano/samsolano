...
```txt
From: 20 February 2025 - To: 25 September 2026

Total Time: 666 hrs 39 mins

TypeScript    332 hrs 40 mins       >>>>>>>>>>>>>>>>>>>>>>>>>   49.23 %
Python        161 hrs 46 mins       >>>>>>>>>>>>>>>>>>>>>>>>>   23.94 %
Markdown      65 hrs 21 mins        >>>>>>>>>>>>>>>>>>>>>>>>>   09.67 %
C             33 hrs 5 mins         >>>>>>>>>>>>>>>>>>>>>>>>>   04.90 %
JSON          15 hrs                >>>>>>>>>>>>>>>>>>>>>>>>>   02.22 %
```
