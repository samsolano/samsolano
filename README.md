...
```txt
From: 20 February 2025 - To: 21 July 2026

Total Time: 587 hrs 38 mins

TypeScript    290 hrs 18 mins       >>>>>>>>>>>>>>>>>>>>>>>>>   49.04 %
Python        161 hrs 41 mins       >>>>>>>>>>>>>>>>>>>>>>>>>   27.31 %
Markdown      39 hrs 45 mins        >>>>>>>>>>>>>>>>>>>>>>>>>   06.72 %
C             33 hrs 5 mins         >>>>>>>>>>>>>>>>>>>>>>>>>   05.59 %
JSON          14 hrs 19 mins        >>>>>>>>>>>>>>>>>>>>>>>>>   02.42 %
```
