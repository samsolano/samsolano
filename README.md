...
```txt
From: 20 February 2025 - To: 09 August 2026

Total Time: 621 hrs 11 mins

TypeScript    305 hrs 20 mins       >>>>>>>>>>>>>>>>>>>>>>>>>   48.68 %
Python        161 hrs 46 mins       >>>>>>>>>>>>>>>>>>>>>>>>>   25.79 %
Markdown      51 hrs 8 mins         >>>>>>>>>>>>>>>>>>>>>>>>>   08.15 %
C             33 hrs 5 mins         >>>>>>>>>>>>>>>>>>>>>>>>>   05.28 %
JSON          14 hrs 52 mins        >>>>>>>>>>>>>>>>>>>>>>>>>   02.37 %
```
