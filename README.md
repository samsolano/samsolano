...
```txt
From: 20 February 2025 - To: 06 August 2026

Total Time: 612 hrs 56 mins

TypeScript    301 hrs 5 mins        >>>>>>>>>>>>>>>>>>>>>>>>>   48.75 %
Python        161 hrs 41 mins       >>>>>>>>>>>>>>>>>>>>>>>>>   26.18 %
Markdown      48 hrs 24 mins        >>>>>>>>>>>>>>>>>>>>>>>>>   07.84 %
C             33 hrs 5 mins         >>>>>>>>>>>>>>>>>>>>>>>>>   05.36 %
JSON          14 hrs 33 mins        >>>>>>>>>>>>>>>>>>>>>>>>>   02.36 %
```
