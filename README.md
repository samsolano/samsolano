...
```txt
From: 20 February 2025 - To: 26 March 2026

Total Time: 469 hrs 13 mins

TypeScript    213 hrs 24 mins       >>>>>>>>>>>>>>>>>>>>>>>>>   45.33 %
Python        147 hrs 52 mins       >>>>>>>>>>>>>>>>>>>>>>>>>   31.41 %
C             33 hrs 5 mins         >>>>>>>>>>>>>>>>>>>>>>>>>   07.03 %
Markdown      22 hrs 30 mins        >>>>>>>>>>>>>>>>>>>>>>>>>   04.78 %
JSON          10 hrs 50 mins        >>>>>>>>>>>>>>>>>>>>>>>>>   02.30 %
```
