...
```txt
From: 20 February 2025 - To: 11 August 2026

Total Time: 631 hrs 54 mins

TypeScript    313 hrs 7 mins        >>>>>>>>>>>>>>>>>>>>>>>>>   49.01 %
Python        161 hrs 46 mins       >>>>>>>>>>>>>>>>>>>>>>>>>   25.32 %
Markdown      53 hrs                >>>>>>>>>>>>>>>>>>>>>>>>>   08.30 %
C             33 hrs 5 mins         >>>>>>>>>>>>>>>>>>>>>>>>>   05.18 %
JSON          14 hrs 52 mins        >>>>>>>>>>>>>>>>>>>>>>>>>   02.33 %
```
