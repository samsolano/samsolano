...
```txt
From: 20 February 2025 - To: 27 June 2025

Total Time: 166 hrs 35 mins

TypeScript    60 hrs 3 mins   >>>>>>>>>>>>>>>>>>>>>>>>>   35.85 %
Python        44 hrs 16 mins  >>>>>>>>>>>>>>>>>>>>>>>>>   26.43 %
C             32 hrs 47 mins  >>>>>>>>>>>>>>>>>>>>>>>>>   19.58 %
JavaScript    9 hrs 34 mins   >>>>>>>>>>>>>>>>>>>>>>>>>   05.72 %
JSON          4 hrs 41 mins   >>>>>>>>>>>>>>>>>>>>>>>>>   02.81 %
```
