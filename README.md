...
```txt
From: 20 February 2025 - To: 19 June 2026

Total Time: 563 hrs 58 mins

TypeScript    275 hrs 54 mins       >>>>>>>>>>>>>>>>>>>>>>>>>   48.62 %
Python        161 hrs 41 mins       >>>>>>>>>>>>>>>>>>>>>>>>>   28.49 %
Markdown      33 hrs 34 mins        >>>>>>>>>>>>>>>>>>>>>>>>>   05.92 %
C             33 hrs 5 mins         >>>>>>>>>>>>>>>>>>>>>>>>>   05.83 %
JSON          13 hrs 29 mins        >>>>>>>>>>>>>>>>>>>>>>>>>   02.38 %
```
