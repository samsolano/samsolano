...
```txt
From: 20 February 2025 - To: 01 April 2026

Total Time: 476 hrs 32 mins

TypeScript    216 hrs 6 mins        >>>>>>>>>>>>>>>>>>>>>>>>>   45.20 %
Python        151 hrs 42 mins       >>>>>>>>>>>>>>>>>>>>>>>>>   31.73 %
C             33 hrs 5 mins         >>>>>>>>>>>>>>>>>>>>>>>>>   06.92 %
Markdown      23 hrs 14 mins        >>>>>>>>>>>>>>>>>>>>>>>>>   04.86 %
JSON          10 hrs 52 mins        >>>>>>>>>>>>>>>>>>>>>>>>>   02.27 %
```
