...
```txt
From: 20 February 2025 - To: 07 June 2025

Total Time: 132 hrs 48 mins

TypeScript    44 hrs 8 mins   >>>>>>>>>>>>>>>>>>>>>>>>>   33.09 %
C             32 hrs 47 mins  >>>>>>>>>>>>>>>>>>>>>>>>>   24.59 %
Python        32 hrs 10 mins  >>>>>>>>>>>>>>>>>>>>>>>>>   24.12 %
JavaScript    9 hrs 15 mins   >>>>>>>>>>>>>>>>>>>>>>>>>   06.94 %
JSON          3 hrs 43 mins   >>>>>>>>>>>>>>>>>>>>>>>>>   02.80 %
```
