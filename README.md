...
```txt
From: 20 February 2025 - To: 13 April 2026

Total Time: 489 hrs 34 mins

TypeScript    222 hrs 8 mins        >>>>>>>>>>>>>>>>>>>>>>>>>   45.23 %
Python        155 hrs 22 mins       >>>>>>>>>>>>>>>>>>>>>>>>>   31.63 %
C             33 hrs 5 mins         >>>>>>>>>>>>>>>>>>>>>>>>>   06.74 %
Markdown      24 hrs 14 mins        >>>>>>>>>>>>>>>>>>>>>>>>>   04.93 %
JSON          11 hrs 47 mins        >>>>>>>>>>>>>>>>>>>>>>>>>   02.40 %
```
