...
```txt
From: 20 February 2025 - To: 21 September 2026

Total Time: 658 hrs 2 mins

TypeScript    329 hrs 3 mins        >>>>>>>>>>>>>>>>>>>>>>>>>   49.45 %
Python        161 hrs 46 mins       >>>>>>>>>>>>>>>>>>>>>>>>>   24.31 %
Markdown      61 hrs 22 mins        >>>>>>>>>>>>>>>>>>>>>>>>>   09.22 %
C             33 hrs 5 mins         >>>>>>>>>>>>>>>>>>>>>>>>>   04.97 %
JSON          15 hrs                >>>>>>>>>>>>>>>>>>>>>>>>>   02.26 %
```
