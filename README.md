...
```txt
From: 20 February 2025 - To: 01 July 2025

Total Time: 169 hrs 1 min

TypeScript    62 hrs 5 mins   >>>>>>>>>>>>>>>>>>>>>>>>>   36.53 %
Python        44 hrs 29 mins  >>>>>>>>>>>>>>>>>>>>>>>>>   26.18 %
C             32 hrs 47 mins  >>>>>>>>>>>>>>>>>>>>>>>>>   19.30 %
JavaScript    9 hrs 34 mins   >>>>>>>>>>>>>>>>>>>>>>>>>   05.64 %
JSON          4 hrs 47 mins   >>>>>>>>>>>>>>>>>>>>>>>>>   02.82 %
```
