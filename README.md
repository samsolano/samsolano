...
```txt
From: 20 February 2025 - To: 08 April 2026

Total Time: 485 hrs 38 mins

TypeScript    220 hrs 41 mins       >>>>>>>>>>>>>>>>>>>>>>>>>   45.30 %
Python        154 hrs 48 mins       >>>>>>>>>>>>>>>>>>>>>>>>>   31.77 %
C             33 hrs 5 mins         >>>>>>>>>>>>>>>>>>>>>>>>>   06.79 %
Markdown      24 hrs 3 mins         >>>>>>>>>>>>>>>>>>>>>>>>>   04.94 %
JSON          10 hrs 52 mins        >>>>>>>>>>>>>>>>>>>>>>>>>   02.23 %
```
