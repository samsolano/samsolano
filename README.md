...
```txt
From: 20 February 2025 - To: 05 May 2026

Total Time: 515 hrs 8 mins

TypeScript    240 hrs 54 mins       >>>>>>>>>>>>>>>>>>>>>>>>>   46.43 %
Python        156 hrs 58 mins       >>>>>>>>>>>>>>>>>>>>>>>>>   30.25 %
C             33 hrs 5 mins         >>>>>>>>>>>>>>>>>>>>>>>>>   06.38 %
Markdown      27 hrs 6 mins         >>>>>>>>>>>>>>>>>>>>>>>>>   05.23 %
JSON          12 hrs 38 mins        >>>>>>>>>>>>>>>>>>>>>>>>>   02.44 %
```
