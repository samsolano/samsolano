...
```txt
From: 20 February 2025 - To: 04 May 2026

Total Time: 513 hrs 15 mins

TypeScript    239 hrs 18 mins       >>>>>>>>>>>>>>>>>>>>>>>>>   46.32 %
Python        156 hrs 58 mins       >>>>>>>>>>>>>>>>>>>>>>>>>   30.38 %
C             33 hrs 5 mins         >>>>>>>>>>>>>>>>>>>>>>>>>   06.41 %
Markdown      26 hrs 51 mins        >>>>>>>>>>>>>>>>>>>>>>>>>   05.20 %
JSON          12 hrs 36 mins        >>>>>>>>>>>>>>>>>>>>>>>>>   02.44 %
```
