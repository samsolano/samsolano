...
```txt
From: 20 February 2025 - To: 22 May 2026

Total Time: 531 hrs 22 mins

TypeScript    250 hrs 6 mins        >>>>>>>>>>>>>>>>>>>>>>>>>   46.81 %
Python        161 hrs 17 mins       >>>>>>>>>>>>>>>>>>>>>>>>>   30.18 %
C             33 hrs 5 mins         >>>>>>>>>>>>>>>>>>>>>>>>>   06.19 %
Markdown      28 hrs                >>>>>>>>>>>>>>>>>>>>>>>>>   05.24 %
JSON          13 hrs 2 mins         >>>>>>>>>>>>>>>>>>>>>>>>>   02.44 %
```
