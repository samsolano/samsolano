...
```txt
From: 20 February 2025 - To: 08 June 2026

Total Time: 551 hrs 25 mins

TypeScript    266 hrs 35 mins       >>>>>>>>>>>>>>>>>>>>>>>>>   48.08 %
Python        161 hrs 32 mins       >>>>>>>>>>>>>>>>>>>>>>>>>   29.13 %
C             33 hrs 5 mins         >>>>>>>>>>>>>>>>>>>>>>>>>   05.97 %
Markdown      30 hrs 45 mins        >>>>>>>>>>>>>>>>>>>>>>>>>   05.55 %
JSON          13 hrs 29 mins        >>>>>>>>>>>>>>>>>>>>>>>>>   02.43 %
```
