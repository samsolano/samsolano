...
```txt
From: 20 February 2025 - To: 18 August 2025

Total Time: 224 hrs 58 mins

TypeScript    91 hrs 49 mins  >>>>>>>>>>>>>>>>>>>>>>>>>   40.64 %
Python        60 hrs 32 mins  >>>>>>>>>>>>>>>>>>>>>>>>>   26.79 %
C             32 hrs 47 mins  >>>>>>>>>>>>>>>>>>>>>>>>>   14.51 %
JavaScript    9 hrs 34 mins   >>>>>>>>>>>>>>>>>>>>>>>>>   04.24 %
JSON          6 hrs 33 mins   >>>>>>>>>>>>>>>>>>>>>>>>>   02.90 %
```
