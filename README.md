...
```txt
From: 20 February 2025 - To: 15 April 2025

Total Time: 70 hrs 6 mins

C             31 hrs 3 mins   >>>>>>>>>>>>>>>>>>>>>>>>>   44.17 %
Python        13 hrs 44 mins  >>>>>>>>>>>>>>>>>>>>>>>>>   19.55 %
TypeScript    10 hrs 50 mins  >>>>>>>>>>>>>>>>>>>>>>>>>   15.41 %
JavaScript    5 hrs 31 mins   >>>>>>>>>>>>>>>>>>>>>>>>>   07.87 %
JSON          2 hrs 13 mins   >>>>>>>>>>>>>>>>>>>>>>>>>   03.17 %
```
