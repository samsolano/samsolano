...
```txt
From: 20 February 2025 - To: 21 June 2025

Total Time: 158 hrs 22 mins

TypeScript    55 hrs 47 mins  >>>>>>>>>>>>>>>>>>>>>>>>>   35.03 %
Python        41 hrs 13 mins  >>>>>>>>>>>>>>>>>>>>>>>>>   25.88 %
C             32 hrs 47 mins  >>>>>>>>>>>>>>>>>>>>>>>>>   20.59 %
JavaScript    9 hrs 34 mins   >>>>>>>>>>>>>>>>>>>>>>>>>   06.01 %
JSON          4 hrs 29 mins   >>>>>>>>>>>>>>>>>>>>>>>>>   02.82 %
```
