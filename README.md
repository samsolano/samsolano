...
```txt
From: 20 February 2025 - To: 27 April 2026

Total Time: 504 hrs 51 mins

TypeScript    233 hrs 5 mins        >>>>>>>>>>>>>>>>>>>>>>>>>   45.89 %
Python        155 hrs 45 mins       >>>>>>>>>>>>>>>>>>>>>>>>>   30.67 %
C             33 hrs 5 mins         >>>>>>>>>>>>>>>>>>>>>>>>>   06.52 %
Markdown      26 hrs 45 mins        >>>>>>>>>>>>>>>>>>>>>>>>>   05.27 %
JSON          12 hrs 30 mins        >>>>>>>>>>>>>>>>>>>>>>>>>   02.46 %
```
