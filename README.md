...
```txt
From: 20 February 2025 - To: 16 April 2025

Total Time: 72 hrs 45 mins

C             31 hrs 41 mins  >>>>>>>>>>>>>>>>>>>>>>>>>   43.43 %
Python        13 hrs 44 mins  >>>>>>>>>>>>>>>>>>>>>>>>>   18.84 %
TypeScript    12 hrs 48 mins  >>>>>>>>>>>>>>>>>>>>>>>>>   17.55 %
JavaScript    5 hrs 31 mins   >>>>>>>>>>>>>>>>>>>>>>>>>   07.58 %
JSON          2 hrs 14 mins   >>>>>>>>>>>>>>>>>>>>>>>>>   03.06 %
```
