...
```txt
From: 20 February 2025 - To: 14 May 2025

Total Time: 104 hrs 52 mins

TypeScript    32 hrs 56 mins  >>>>>>>>>>>>>>>>>>>>>>>>>   31.28 %
C             32 hrs 45 mins  >>>>>>>>>>>>>>>>>>>>>>>>>   31.10 %
Python        17 hrs 54 mins  >>>>>>>>>>>>>>>>>>>>>>>>>   17.01 %
JavaScript    8 hrs 52 mins   >>>>>>>>>>>>>>>>>>>>>>>>>   08.43 %
JSON          2 hrs 58 mins   >>>>>>>>>>>>>>>>>>>>>>>>>   02.83 %
```
