...
```txt
From: 20 February 2025 - To: 08 August 2026

Total Time: 618 hrs 22 mins

TypeScript    302 hrs 59 mins       >>>>>>>>>>>>>>>>>>>>>>>>>   48.58 %
Python        161 hrs 46 mins       >>>>>>>>>>>>>>>>>>>>>>>>>   25.94 %
Markdown      51 hrs 8 mins         >>>>>>>>>>>>>>>>>>>>>>>>>   08.20 %
C             33 hrs 5 mins         >>>>>>>>>>>>>>>>>>>>>>>>>   05.31 %
JSON          14 hrs 33 mins        >>>>>>>>>>>>>>>>>>>>>>>>>   02.34 %
```
