...
```txt
From: 20 February 2025 - To: 23 September 2026

Total Time: 662 hrs 2 mins

TypeScript    330 hrs 5 mins        >>>>>>>>>>>>>>>>>>>>>>>>>   49.24 %
Python        161 hrs 46 mins       >>>>>>>>>>>>>>>>>>>>>>>>>   24.13 %
Markdown      63 hrs 37 mins        >>>>>>>>>>>>>>>>>>>>>>>>>   09.49 %
C             33 hrs 5 mins         >>>>>>>>>>>>>>>>>>>>>>>>>   04.94 %
JSON          15 hrs                >>>>>>>>>>>>>>>>>>>>>>>>>   02.24 %
```
