...
```txt
From: 20 February 2025 - To: 11 June 2025

Total Time: 133 hrs 12 mins

TypeScript    44 hrs 20 mins  >>>>>>>>>>>>>>>>>>>>>>>>>   33.07 %
C             32 hrs 47 mins  >>>>>>>>>>>>>>>>>>>>>>>>>   24.46 %
Python        32 hrs 10 mins  >>>>>>>>>>>>>>>>>>>>>>>>>   24.00 %
JavaScript    9 hrs 15 mins   >>>>>>>>>>>>>>>>>>>>>>>>>   06.91 %
JSON          3 hrs 53 mins   >>>>>>>>>>>>>>>>>>>>>>>>>   02.90 %
```
