...
```txt
From: 20 February 2025 - To: 24 April 2026

Total Time: 494 hrs 59 mins

TypeScript    224 hrs 56 mins       >>>>>>>>>>>>>>>>>>>>>>>>>   45.20 %
Python        155 hrs 42 mins       >>>>>>>>>>>>>>>>>>>>>>>>>   31.29 %
C             33 hrs 5 mins         >>>>>>>>>>>>>>>>>>>>>>>>>   06.65 %
Markdown      25 hrs 26 mins        >>>>>>>>>>>>>>>>>>>>>>>>>   05.11 %
JSON          12 hrs 20 mins        >>>>>>>>>>>>>>>>>>>>>>>>>   02.48 %
```
