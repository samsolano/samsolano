...
```txt
From: 20 February 2025 - To: 12 July 2025

Total Time: 180 hrs 45 mins

TypeScript    69 hrs 24 mins  >>>>>>>>>>>>>>>>>>>>>>>>>   38.20 %
Python        45 hrs 53 mins  >>>>>>>>>>>>>>>>>>>>>>>>>   25.26 %
C             32 hrs 47 mins  >>>>>>>>>>>>>>>>>>>>>>>>>   18.05 %
JavaScript    9 hrs 34 mins   >>>>>>>>>>>>>>>>>>>>>>>>>   05.27 %
JSON          5 hrs 6 mins    >>>>>>>>>>>>>>>>>>>>>>>>>   02.81 %
```
