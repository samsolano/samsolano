...
```txt
From: 20 February 2025 - To: 29 May 2026

Total Time: 537 hrs 4 mins

TypeScript    255 hrs 18 mins       >>>>>>>>>>>>>>>>>>>>>>>>>   47.27 %
Python        161 hrs 32 mins       >>>>>>>>>>>>>>>>>>>>>>>>>   29.91 %
C             33 hrs 5 mins         >>>>>>>>>>>>>>>>>>>>>>>>>   06.13 %
Markdown      28 hrs 11 mins        >>>>>>>>>>>>>>>>>>>>>>>>>   05.22 %
JSON          13 hrs 3 mins         >>>>>>>>>>>>>>>>>>>>>>>>>   02.42 %
```
