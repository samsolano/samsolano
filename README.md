...
```txt
From: 20 February 2025 - To: 29 April 2025

Total Time: 87 hrs 56 mins

C             31 hrs 57 mins  >>>>>>>>>>>>>>>>>>>>>>>>>   36.19 %
TypeScript    21 hrs 28 mins  >>>>>>>>>>>>>>>>>>>>>>>>>   24.31 %
Python        17 hrs 45 mins  >>>>>>>>>>>>>>>>>>>>>>>>>   20.11 %
JavaScript    6 hrs 55 mins   >>>>>>>>>>>>>>>>>>>>>>>>>   07.85 %
JSON          2 hrs 28 mins   >>>>>>>>>>>>>>>>>>>>>>>>>   02.79 %
```
