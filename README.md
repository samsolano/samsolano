...
```txt
From: 20 February 2025 - To: 19 July 2026

Total Time: 586 hrs 16 mins

TypeScript    289 hrs 32 mins       >>>>>>>>>>>>>>>>>>>>>>>>>   49.02 %
Python        161 hrs 41 mins       >>>>>>>>>>>>>>>>>>>>>>>>>   27.38 %
Markdown      39 hrs 37 mins        >>>>>>>>>>>>>>>>>>>>>>>>>   06.71 %
C             33 hrs 5 mins         >>>>>>>>>>>>>>>>>>>>>>>>>   05.60 %
JSON          14 hrs 19 mins        >>>>>>>>>>>>>>>>>>>>>>>>>   02.43 %
```
