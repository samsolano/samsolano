...
```txt
From: 20 February 2025 - To: 16 July 2026

Total Time: 584 hrs 29 mins

TypeScript    289 hrs 8 mins        >>>>>>>>>>>>>>>>>>>>>>>>>   49.11 %
Python        161 hrs 41 mins       >>>>>>>>>>>>>>>>>>>>>>>>>   27.46 %
Markdown      39 hrs 2 mins         >>>>>>>>>>>>>>>>>>>>>>>>>   06.63 %
C             33 hrs 5 mins         >>>>>>>>>>>>>>>>>>>>>>>>>   05.62 %
JSON          13 hrs 50 mins        >>>>>>>>>>>>>>>>>>>>>>>>>   02.35 %
```
