...
```txt
From: 20 February 2025 - To: 25 March 2026

Total Time: 467 hrs 44 mins

TypeScript    212 hrs 37 mins       >>>>>>>>>>>>>>>>>>>>>>>>>   45.31 %
Python        147 hrs 52 mins       >>>>>>>>>>>>>>>>>>>>>>>>>   31.51 %
C             33 hrs 5 mins         >>>>>>>>>>>>>>>>>>>>>>>>>   07.05 %
Markdown      22 hrs 9 mins         >>>>>>>>>>>>>>>>>>>>>>>>>   04.72 %
JSON          10 hrs 31 mins        >>>>>>>>>>>>>>>>>>>>>>>>>   02.24 %
```
