...
```txt
From: 20 February 2025 - To: 08 March 2026

Total Time: 460 hrs 53 mins

TypeScript    207 hrs 58 mins       >>>>>>>>>>>>>>>>>>>>>>>>>   44.97 %
Python        146 hrs 4 mins        >>>>>>>>>>>>>>>>>>>>>>>>>   31.59 %
C             33 hrs 5 mins         >>>>>>>>>>>>>>>>>>>>>>>>>   07.16 %
Markdown      21 hrs 50 mins        >>>>>>>>>>>>>>>>>>>>>>>>>   04.72 %
JSON          10 hrs 31 mins        >>>>>>>>>>>>>>>>>>>>>>>>>   02.28 %
```
