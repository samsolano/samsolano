...
```txt
From: 20 February 2025 - To: 16 April 2026

Total Time: 492 hrs 45 mins

TypeScript    223 hrs 40 mins       >>>>>>>>>>>>>>>>>>>>>>>>>   45.17 %
Python        155 hrs 42 mins       >>>>>>>>>>>>>>>>>>>>>>>>>   31.44 %
C             33 hrs 5 mins         >>>>>>>>>>>>>>>>>>>>>>>>>   06.68 %
Markdown      24 hrs 37 mins        >>>>>>>>>>>>>>>>>>>>>>>>>   04.97 %
JSON          12 hrs 11 mins        >>>>>>>>>>>>>>>>>>>>>>>>>   02.46 %
```
