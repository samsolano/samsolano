...
```txt
From: 20 February 2025 - To: 25 April 2026

Total Time: 502 hrs 35 mins

TypeScript    231 hrs 16 mins       >>>>>>>>>>>>>>>>>>>>>>>>>   45.75 %
Python        155 hrs 45 mins       >>>>>>>>>>>>>>>>>>>>>>>>>   30.81 %
C             33 hrs 5 mins         >>>>>>>>>>>>>>>>>>>>>>>>>   06.55 %
Markdown      26 hrs 24 mins        >>>>>>>>>>>>>>>>>>>>>>>>>   05.22 %
JSON          12 hrs 29 mins        >>>>>>>>>>>>>>>>>>>>>>>>>   02.47 %
```
