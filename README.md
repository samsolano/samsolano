...
```txt
From: 20 February 2025 - To: 01 August 2025

Total Time: 201 hrs 15 mins

TypeScript    81 hrs 5 mins   >>>>>>>>>>>>>>>>>>>>>>>>>   40.11 %
Python        53 hrs 8 mins   >>>>>>>>>>>>>>>>>>>>>>>>>   26.28 %
C             32 hrs 47 mins  >>>>>>>>>>>>>>>>>>>>>>>>>   16.22 %
JavaScript    9 hrs 34 mins   >>>>>>>>>>>>>>>>>>>>>>>>>   04.74 %
JSON          5 hrs 41 mins   >>>>>>>>>>>>>>>>>>>>>>>>>   02.81 %
```
