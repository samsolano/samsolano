...
```txt
From: 20 February 2025 - To: 19 May 2025

Total Time: 116 hrs 23 mins

TypeScript    36 hrs 2 mins   >>>>>>>>>>>>>>>>>>>>>>>>>   30.85 %
C             32 hrs 45 mins  >>>>>>>>>>>>>>>>>>>>>>>>>   28.03 %
Python        25 hrs 26 mins  >>>>>>>>>>>>>>>>>>>>>>>>>   21.78 %
JavaScript    9 hrs 11 mins   >>>>>>>>>>>>>>>>>>>>>>>>>   07.87 %
JSON          3 hrs 6 mins    >>>>>>>>>>>>>>>>>>>>>>>>>   02.66 %
```
