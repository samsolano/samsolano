...
```txt
From: 20 February 2025 - To: 10 August 2025

Total Time: 207 hrs 39 mins

TypeScript    82 hrs 8 mins   >>>>>>>>>>>>>>>>>>>>>>>>>   39.37 %
Python        57 hrs 58 mins  >>>>>>>>>>>>>>>>>>>>>>>>>   27.79 %
C             32 hrs 47 mins  >>>>>>>>>>>>>>>>>>>>>>>>>   15.72 %
JavaScript    9 hrs 34 mins   >>>>>>>>>>>>>>>>>>>>>>>>>   04.59 %
JSON          5 hrs 49 mins   >>>>>>>>>>>>>>>>>>>>>>>>>   02.79 %
```
