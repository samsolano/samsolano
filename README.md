...
```txt
From: 20 February 2025 - To: 29 March 2026

Total Time: 471 hrs 45 mins

TypeScript    214 hrs 15 mins       >>>>>>>>>>>>>>>>>>>>>>>>>   45.26 %
Python        149 hrs 14 mins       >>>>>>>>>>>>>>>>>>>>>>>>>   31.53 %
C             33 hrs 5 mins         >>>>>>>>>>>>>>>>>>>>>>>>>   06.99 %
Markdown      22 hrs 48 mins        >>>>>>>>>>>>>>>>>>>>>>>>>   04.82 %
JSON          10 hrs 52 mins        >>>>>>>>>>>>>>>>>>>>>>>>>   02.30 %
```
