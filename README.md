...
```txt
From: 20 February 2025 - To: 11 July 2026

Total Time: 578 hrs 57 mins

TypeScript    285 hrs 10 mins       >>>>>>>>>>>>>>>>>>>>>>>>>   48.93 %
Python        161 hrs 41 mins       >>>>>>>>>>>>>>>>>>>>>>>>>   27.74 %
Markdown      37 hrs 45 mins        >>>>>>>>>>>>>>>>>>>>>>>>>   06.48 %
C             33 hrs 5 mins         >>>>>>>>>>>>>>>>>>>>>>>>>   05.68 %
JSON          13 hrs 49 mins        >>>>>>>>>>>>>>>>>>>>>>>>>   02.37 %
```
