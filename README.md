...
```txt
From: 20 February 2025 - To: 10 June 2026

Total Time: 557 hrs 21 mins

TypeScript    271 hrs 30 mins       >>>>>>>>>>>>>>>>>>>>>>>>>   48.43 %
Python        161 hrs 33 mins       >>>>>>>>>>>>>>>>>>>>>>>>>   28.82 %
C             33 hrs 5 mins         >>>>>>>>>>>>>>>>>>>>>>>>>   05.90 %
Markdown      31 hrs 33 mins        >>>>>>>>>>>>>>>>>>>>>>>>>   05.63 %
JSON          13 hrs 29 mins        >>>>>>>>>>>>>>>>>>>>>>>>>   02.41 %
```
