...
```txt
From: 20 February 2025 - To: 24 August 2025

Total Time: 238 hrs 15 mins

TypeScript    98 hrs 35 mins  >>>>>>>>>>>>>>>>>>>>>>>>>   41.20 %
Python        63 hrs 17 mins  >>>>>>>>>>>>>>>>>>>>>>>>>   26.45 %
C             32 hrs 47 mins  >>>>>>>>>>>>>>>>>>>>>>>>>   13.70 %
JavaScript    9 hrs 35 mins   >>>>>>>>>>>>>>>>>>>>>>>>>   04.01 %
Markdown      8 hrs           >>>>>>>>>>>>>>>>>>>>>>>>>   03.34 %
```
