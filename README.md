...
```txt
From: 20 February 2025 - To: 04 April 2026

Total Time: 482 hrs 13 mins

TypeScript    219 hrs 31 mins       >>>>>>>>>>>>>>>>>>>>>>>>>   45.38 %
Python        153 hrs 27 mins       >>>>>>>>>>>>>>>>>>>>>>>>>   31.72 %
C             33 hrs 5 mins         >>>>>>>>>>>>>>>>>>>>>>>>>   06.84 %
Markdown      23 hrs 45 mins        >>>>>>>>>>>>>>>>>>>>>>>>>   04.91 %
JSON          10 hrs 52 mins        >>>>>>>>>>>>>>>>>>>>>>>>>   02.25 %
```
