...
```txt
From: 20 February 2025 - To: 23 July 2026

Total Time: 598 hrs 26 mins

TypeScript    294 hrs 52 mins       >>>>>>>>>>>>>>>>>>>>>>>>>   48.90 %
Python        161 hrs 41 mins       >>>>>>>>>>>>>>>>>>>>>>>>>   26.81 %
Markdown      43 hrs 46 mins        >>>>>>>>>>>>>>>>>>>>>>>>>   07.26 %
C             33 hrs 5 mins         >>>>>>>>>>>>>>>>>>>>>>>>>   05.49 %
JSON          14 hrs 33 mins        >>>>>>>>>>>>>>>>>>>>>>>>>   02.42 %
```
