...
```txt
From: 20 February 2025 - To: 29 May 2025

Total Time: 127 hrs 35 mins

TypeScript    42 hrs 7 mins   >>>>>>>>>>>>>>>>>>>>>>>>>   32.87 %
C             32 hrs 45 mins  >>>>>>>>>>>>>>>>>>>>>>>>>   25.56 %
Python        29 hrs 40 mins  >>>>>>>>>>>>>>>>>>>>>>>>>   23.15 %
JavaScript    9 hrs 15 mins   >>>>>>>>>>>>>>>>>>>>>>>>>   07.23 %
JSON          3 hrs 36 mins   >>>>>>>>>>>>>>>>>>>>>>>>>   02.81 %
```
