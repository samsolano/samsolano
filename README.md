...
```txt
From: 20 February 2025 - To: 10 July 2026

Total Time: 577 hrs 27 mins

TypeScript    284 hrs 11 mins       >>>>>>>>>>>>>>>>>>>>>>>>>   48.89 %
Python        161 hrs 41 mins       >>>>>>>>>>>>>>>>>>>>>>>>>   27.81 %
Markdown      37 hrs 26 mins        >>>>>>>>>>>>>>>>>>>>>>>>>   06.44 %
C             33 hrs 5 mins         >>>>>>>>>>>>>>>>>>>>>>>>>   05.69 %
JSON          13 hrs 49 mins        >>>>>>>>>>>>>>>>>>>>>>>>>   02.38 %
```
