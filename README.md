...
```txt
From: 20 February 2025 - To: 15 September 2026

Total Time: 652 hrs

TypeScript    325 hrs 16 mins       >>>>>>>>>>>>>>>>>>>>>>>>>   49.33 %
Python        161 hrs 46 mins       >>>>>>>>>>>>>>>>>>>>>>>>>   24.53 %
Markdown      60 hrs 20 mins        >>>>>>>>>>>>>>>>>>>>>>>>>   09.15 %
C             33 hrs 5 mins         >>>>>>>>>>>>>>>>>>>>>>>>>   05.02 %
JSON          14 hrs 53 mins        >>>>>>>>>>>>>>>>>>>>>>>>>   02.26 %
```
