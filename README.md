...
```txt
From: 20 February 2025 - To: 02 May 2026

Total Time: 511 hrs 50 mins

TypeScript    238 hrs               >>>>>>>>>>>>>>>>>>>>>>>>>   46.20 %
Python        156 hrs 58 mins       >>>>>>>>>>>>>>>>>>>>>>>>>   30.47 %
C             33 hrs 5 mins         >>>>>>>>>>>>>>>>>>>>>>>>>   06.42 %
Markdown      26 hrs 46 mins        >>>>>>>>>>>>>>>>>>>>>>>>>   05.20 %
JSON          12 hrs 35 mins        >>>>>>>>>>>>>>>>>>>>>>>>>   02.44 %
```
