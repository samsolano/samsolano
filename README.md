...
```txt
From: 20 February 2025 - To: 24 March 2026

Total Time: 467 hrs 15 mins

TypeScript    212 hrs 26 mins       >>>>>>>>>>>>>>>>>>>>>>>>>   45.32 %
Python        147 hrs 52 mins       >>>>>>>>>>>>>>>>>>>>>>>>>   31.54 %
C             33 hrs 5 mins         >>>>>>>>>>>>>>>>>>>>>>>>>   07.06 %
Markdown      21 hrs 51 mins        >>>>>>>>>>>>>>>>>>>>>>>>>   04.66 %
JSON          10 hrs 31 mins        >>>>>>>>>>>>>>>>>>>>>>>>>   02.25 %
```
