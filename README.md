...
```txt
From: 20 February 2025 - To: 14 August 2025

Total Time: 216 hrs 51 mins

TypeScript    87 hrs 40 mins  >>>>>>>>>>>>>>>>>>>>>>>>>   40.25 %
Python        60 hrs 32 mins  >>>>>>>>>>>>>>>>>>>>>>>>>   27.79 %
C             32 hrs 47 mins  >>>>>>>>>>>>>>>>>>>>>>>>>   15.06 %
JavaScript    9 hrs 34 mins   >>>>>>>>>>>>>>>>>>>>>>>>>   04.40 %
JSON          5 hrs 57 mins   >>>>>>>>>>>>>>>>>>>>>>>>>   02.74 %
```
