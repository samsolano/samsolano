...
```txt
From: 20 February 2025 - To: 15 July 2026

Total Time: 582 hrs 1 min

TypeScript    287 hrs 11 mins       >>>>>>>>>>>>>>>>>>>>>>>>>   49.00 %
Python        161 hrs 41 mins       >>>>>>>>>>>>>>>>>>>>>>>>>   27.59 %
Markdown      38 hrs 32 mins        >>>>>>>>>>>>>>>>>>>>>>>>>   06.58 %
C             33 hrs 5 mins         >>>>>>>>>>>>>>>>>>>>>>>>>   05.65 %
JSON          13 hrs 50 mins        >>>>>>>>>>>>>>>>>>>>>>>>>   02.36 %
```
