...
```txt
From: 20 February 2025 - To: 03 July 2025

Total Time: 174 hrs 32 mins

TypeScript    65 hrs 34 mins  >>>>>>>>>>>>>>>>>>>>>>>>>   37.37 %
Python        45 hrs 17 mins  >>>>>>>>>>>>>>>>>>>>>>>>>   25.82 %
C             32 hrs 47 mins  >>>>>>>>>>>>>>>>>>>>>>>>>   18.69 %
JavaScript    9 hrs 34 mins   >>>>>>>>>>>>>>>>>>>>>>>>>   05.46 %
JSON          4 hrs 48 mins   >>>>>>>>>>>>>>>>>>>>>>>>>   02.74 %
```
