...
```txt
From: 20 February 2025 - To: 22 September 2026

Total Time: 659 hrs 48 mins

TypeScript    330 hrs 1 min         >>>>>>>>>>>>>>>>>>>>>>>>>   49.39 %
Python        161 hrs 46 mins       >>>>>>>>>>>>>>>>>>>>>>>>>   24.21 %
Markdown      61 hrs 26 mins        >>>>>>>>>>>>>>>>>>>>>>>>>   09.20 %
C             33 hrs 5 mins         >>>>>>>>>>>>>>>>>>>>>>>>>   04.95 %
JSON          15 hrs                >>>>>>>>>>>>>>>>>>>>>>>>>   02.25 %
```
