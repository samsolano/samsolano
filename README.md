...
```txt
From: 20 February 2025 - To: 25 June 2026

Total Time: 564 hrs 33 mins

TypeScript    275 hrs 55 mins       >>>>>>>>>>>>>>>>>>>>>>>>>   48.58 %
Python        161 hrs 41 mins       >>>>>>>>>>>>>>>>>>>>>>>>>   28.46 %
Markdown      33 hrs 44 mins        >>>>>>>>>>>>>>>>>>>>>>>>>   05.94 %
C             33 hrs 5 mins         >>>>>>>>>>>>>>>>>>>>>>>>>   05.83 %
JSON          13 hrs 45 mins        >>>>>>>>>>>>>>>>>>>>>>>>>   02.42 %
```
