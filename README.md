...
```txt
From: 20 February 2025 - To: 17 June 2025

Total Time: 150 hrs 34 mins

TypeScript    52 hrs 27 mins  >>>>>>>>>>>>>>>>>>>>>>>>>   34.62 %
Python        38 hrs 13 mins  >>>>>>>>>>>>>>>>>>>>>>>>>   25.24 %
C             32 hrs 47 mins  >>>>>>>>>>>>>>>>>>>>>>>>>   21.65 %
JavaScript    9 hrs 34 mins   >>>>>>>>>>>>>>>>>>>>>>>>>   06.32 %
JSON          4 hrs 18 mins   >>>>>>>>>>>>>>>>>>>>>>>>>   02.84 %
```
