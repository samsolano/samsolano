...
```txt
From: 20 February 2025 - To: 12 June 2025

Total Time: 134 hrs 19 mins

TypeScript    45 hrs 22 mins  >>>>>>>>>>>>>>>>>>>>>>>>>   33.57 %
C             32 hrs 47 mins  >>>>>>>>>>>>>>>>>>>>>>>>>   24.26 %
Python        32 hrs 10 mins  >>>>>>>>>>>>>>>>>>>>>>>>>   23.80 %
JavaScript    9 hrs 15 mins   >>>>>>>>>>>>>>>>>>>>>>>>>   06.85 %
JSON          3 hrs 57 mins   >>>>>>>>>>>>>>>>>>>>>>>>>   02.92 %
```
