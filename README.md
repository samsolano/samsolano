...
```txt
From: 20 February 2025 - To: 01 June 2025

Total Time: 131 hrs 45 mins

TypeScript    43 hrs 47 mins  >>>>>>>>>>>>>>>>>>>>>>>>>   33.11 %
C             32 hrs 45 mins  >>>>>>>>>>>>>>>>>>>>>>>>>   24.76 %
Python        32 hrs 8 mins   >>>>>>>>>>>>>>>>>>>>>>>>>   24.30 %
JavaScript    9 hrs 15 mins   >>>>>>>>>>>>>>>>>>>>>>>>>   07.00 %
JSON          3 hrs 36 mins   >>>>>>>>>>>>>>>>>>>>>>>>>   02.72 %
```
