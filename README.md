...
```txt
From: 20 February 2025 - To: 11 June 2026

Total Time: 559 hrs 17 mins

TypeScript    273 hrs 3 mins        >>>>>>>>>>>>>>>>>>>>>>>>>   48.54 %
Python        161 hrs 41 mins       >>>>>>>>>>>>>>>>>>>>>>>>>   28.74 %
C             33 hrs 5 mins         >>>>>>>>>>>>>>>>>>>>>>>>>   05.88 %
Markdown      31 hrs 47 mins        >>>>>>>>>>>>>>>>>>>>>>>>>   05.65 %
JSON          13 hrs 29 mins        >>>>>>>>>>>>>>>>>>>>>>>>>   02.40 %
```
