...
```txt
From: 20 February 2025 - To: 05 April 2026

Total Time: 483 hrs 54 mins

TypeScript    219 hrs 54 mins       >>>>>>>>>>>>>>>>>>>>>>>>>   45.29 %
Python        154 hrs 26 mins       >>>>>>>>>>>>>>>>>>>>>>>>>   31.81 %
C             33 hrs 5 mins         >>>>>>>>>>>>>>>>>>>>>>>>>   06.82 %
Markdown      24 hrs                >>>>>>>>>>>>>>>>>>>>>>>>>   04.94 %
JSON          10 hrs 52 mins        >>>>>>>>>>>>>>>>>>>>>>>>>   02.24 %
```
